 ...
 */
public class CreateReportTaskView extends javax.swing.JFrame {
    private Task task;
    ...
    public CreateReportTaskView(Task task) {
        this.task = task;
    ...
    private void confirmBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmBtnActionPerformed
        ...
        try {
            this.taskReportController.createReport(this.task, title, description);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreateReportTaskView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CreateReportTaskView().setVisible(true);
            }
        });
    }
