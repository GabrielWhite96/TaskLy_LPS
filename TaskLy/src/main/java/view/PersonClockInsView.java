 ...
 */
public class PersonClockInsView extends javax.swing.JFrame {
    ...
    public PersonClockInsView(Person person) {
        this.person = person;
    ...
    public void showCards() {
        try {
            ...
            List<ClockIn> clockIns = this.clockInController.getClockInOf(this.person);
    ...
    private void initComponents() {
        ...
        titleLB.setFont(new java.awt.Font("Trebuchet MS", 0, 24)); // NOI18N
        titleLB.setText("Menu de Projetos");
        titleLB.setToolTipText("");
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(15, 15, 15)
                .addComponent(titleLB, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PersonClockInsView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PersonClockInsView().setVisible(true);
            }
        });
    }
