 ...
 */
public class TasksMenuView extends javax.swing.JFrame {
            ...
            for (Task task : tasks) {
                ...
                projectButton.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        TasksMenuView.this.showTaskScreen(task);
                    }
                });
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TasksMenuView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TasksMenuView().setVisible(true);
            }
        });
    }
